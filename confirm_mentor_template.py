...
class="hide">&nbsp;&nbsp; MEST Mentor Platform<br>
</span></div>
<table class="w325" border="0" cellpadding="0"
cellspacing="0" width="350">
<tbody>
				...
				<div class="article-content" align="left">
					<span style="color: rgb(102, 102, 102);">
						<p>
							...
							*|contributors_full_name|* just logged *|contributed_hours|* hours for assisting *|company_name|*. This is what *|contributors_first_name|* worked on:
